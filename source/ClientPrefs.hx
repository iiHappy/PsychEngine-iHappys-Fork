...
class ClientPrefs {
	...
	public static var coolhealthbar:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.coolhealthbar = coolhealthbar;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.coolhealthbar != null) {
			coolhealthbar = FlxG.save.data.coolhealthbar;
		}
