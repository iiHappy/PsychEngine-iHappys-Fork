...
class WarningState extends MusicBeatState
{
	...
	function addInfoTexts()
	{
		...
		warnText.setFormat("PhantomMuff 1.5", 50, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		text.setFormat("PhantomMuff 1.5", 30, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
