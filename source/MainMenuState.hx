...
class MainMenuState extends MusicBeatState
{
	...
	public static var happyEngineVersion:String = '1.0.0'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		camGame.zoom = 3;
		FlxTween.tween(camGame, {zoom: 1}, 2.1, {ease: FlxEase.expoInOut});
		FlxTween.tween(bg, {angle: 0}, 2, {ease: FlxEase.quartInOut});
		
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Happy Engine v" + happyEngineVersion, 12);
		...
		if (!selectedSomethin && selectable)
		{
			...
			if (controls.ACCEPT)
			{
				...
				else
				{
					...
					FlxTween.tween(camGame, {zoom: 3}, 2.6, {ease: FlxEase.expoInOut});
